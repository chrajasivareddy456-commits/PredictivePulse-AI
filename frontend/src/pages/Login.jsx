    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="panel shadow-panel p-6 space-y-4">
          <h2 className="text-sm font-medium text-graphite-500 uppercase tracking-wide">Sign In</h2>
          ...
          <p className="text-xs text-graphite-500 text-center">
            No account? <Link to="/register" className="text-pulse-400 hover:underline">Register</Link>
          </p>
        </form>
      </div>
    </div>
